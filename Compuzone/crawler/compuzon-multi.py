...
def get_product_data(driver):
    ...
    for i in range(1, len(list_cnt) + 1):
        ...
        # //*[@id="product_list_ul"]/li[1]/div[2]/div[2]/div[2]
        # //*[@id="product_list_ul"]/li[2]/div[2]/div[2]/div[2]
        try:
...
def scrape_data(url_title_method):
    ...
    #date_str = time.strftime("%Y-%m-%d %H:%M:%S")
    #output_dir = os.path.join("compuzon", title)
    output_dir = "compuzon"
...
def main():
    ...
    titles = ['cpu', 'mainboard', 'memory', 'ssd', 'power', 'cooler', 'gpu', 'case', 'case', 'case']
